...
test('edgesInLineWith', t => {
  ...
  g.addEdgeAndVertices(new Edge(new Point(-4, -5), new Point(-3, -4)));
  g.addEdgeAndVertices(new Edge(new Point(0, -3), new Point(3, -3)));
  t.is(g.edgesInLineWith(new Edge(new Point(2, 1), new Point(3, 2))).length, 3);
  t.is(g.edgesInLineWith(new Edge(new Point(-1, 0), new Point(-1, -1))).length, 1);
  t.is(g.edgesInLineWith(new Edge(new Point(-2, 0), new Point(-2, -1))).length, 2);
  t.is(g.edgesInLineWith(new Edge(new Point(-3, 0), new Point(-2, -1))).length, 0);
  t.is(g.edgesInLineWith(new Edge(new Point(-3, -3), new Point(-2, -3))).length, 1);
  t.end();
});
