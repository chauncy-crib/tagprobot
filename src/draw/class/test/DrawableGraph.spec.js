...
test('DrawableGraph', tester => {
  ...
  tester.test(
    'removeVertex replaces removed vertex with the vertex at the final position in the container',
    t => {
      ...
      // Should move the last drawing in the container to replace 2, 2. removeChildAt should be
      //   called twice
