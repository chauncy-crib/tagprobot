  ...
  _.forOwn(
    {
      ...
      SPEEDPAD_WARNING: { id: '5.11', traversable: true, permanent: false },
      POWERUP_SUBGROUP: { id: 6, traversable: true, radius: 15, permanent: false },
      JUKEJUICE: { id: 6.1, traversable: true, radius: 15, permanent: false },
      JUKEJUICE_WARNING: { id: 6.11, traversable: true, permanent: false },
      ROLLING_BOMB: { id: 6.2, traversable: true, radius: 15, permanent: false },
      ROLLING_BOMB_WARNING: { id: 6.21, traversable: true, permanent: false },
      TAGPRO: { id: 6.3, traversable: true, radius: 15, permanent: false },
      TAGPRO_WARNING: { id: 6.31, traversable: true, permanent: false },
      MAX_SPEED: { id: 6.4, traversable: true, radius: 15, permanent: false },
      MAX_SPEED_WARNING: { id: 6.41, traversable: true, permanent: false },
      SPIKE: { id: 7, traversable: false, radius: 14, permanent: true },
      BUTTON: { id: 8, traversable: true, radius: 8, permanent: true },
      ...
      BOMB_WARNING: { id: '10.11', traversable: true, permanent: false },
      RED_TEAMTILE: { id: 11, traversable: true, permanent: true },
      BLUE_TEAMTILE: { id: 12, traversable: true, permanent: true },
      ACTIVE_PORTAL: { id: 13, traversable: true, radius: 15, permanent: false },
      INACTIVE_PORTAL: { id: '13.1', traversable: true, permanent: false },
      PORTAL_WARNING: { id: '13.11', traversable: true, permanent: false },
      ...
      SPEEDPAD_RED_WARNING: { id: '14.11', traversable: true, permanent: false },
      ...
      SPEEDPAD_BLUE_WARNING: { id: '15.11', traversable: true, permanent: false },
