...
import { threePointsInLine, areEdgesColinnear } from '../utils/graphUtils';
 ...
 * @param {} smallE - An edge which may or may not be in the unmergedGraph, which spans one
 *   tile-length, or diagonally across one tile.
 */
function updateMergedEdge(mergedGraph, unmergedGraph, bigE, smallE) {
  ...
  assert(areEdgesColinnear(bigE, smallE));
