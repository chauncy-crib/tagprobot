...
/**
 * Stores the appropriate funnelled path when the worker is done.
 */
...
/**
 * Tells the worker to start calculating the appropriate funnel and returns the previous stored
 *   funnel according to the key.
...
/**
 * Tells the worker to start calculating my funnel and returns the previous stored my funnel.
 * @param {PolypointState[]} path
 * @param {TriangleGraph} triangleGraph
 * @returns {PolypointState[]} a list of states, starting from the startState to the targetState
 *   that are funnelled to be as straight as possible
...
/**
 * Tells the worker to start calculating enemy funnel and returns the previous stored enemy funnel.
 * @param {PolypointState[]} path
 * @param {TriangleGraph} triangleGraph
 * @returns {PolypointState[]} a list of states, starting from the startState to the targetState
 *   that are funnelled to be as straight as possible
