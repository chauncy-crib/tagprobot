 ...
 * @returns {(number|boolean)} the property for the input tile
 */
 ...
 * @returns {number} the id for the input tile name
 */
 ...
 * @param {String} name the name of a tile
 * @returns {boolean} true if tileId is the id of the named tile
 */
