...
export class Matrix {
   ...
   * @param {0|1} [axis] - 0 to append matrix as a row, 1 to append matrix as a column
   */
  append(other, axis = 0) {
  ...
  /**
   * @returns {number[]} the number of rows, columns, and third-dimensions in the matrix according
   *   to how many dimensions it has.  Takes the format [rows, columns, third-dimensions]
   */
  shape() {
