 ...
 * @param {TriangleTreeNode[]} regNodes - a array of nodes containing triangles that span across
 *   the region
 * @param {Triangle[]} newTriangles - a array to store every new triangle the function creates in
 */
